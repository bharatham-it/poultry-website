jQuery( document ).ready(function($) {
	...
	$('.sortable_repeater_control').each(function() {
		...
		var defaultValuesArray = new Array("main-banner","about-me","promo-banner","amazing-features","awesome-screenshot","plans-pricing","our-team","testimonial","record","newsletter","latest-posts","contact-us");
